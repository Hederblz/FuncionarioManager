CREATE DATABASE  IF NOT EXISTS `funcionariosdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `funcionariosdb`;
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
-- Host: localhost    Database: funcionariosdb
-- ------------------------------------------------------
...
CREATE TABLE `tbfuncionario` (
  ...
  KEY `fk_tbFuncionarios_tbCargos1` (`CodTbCargo`),
  CONSTRAINT `fk_tbFuncionarios_tbCargos1` FOREIGN KEY (`CodTbCargo`) REFERENCES `tbcargo` (`idTbCargo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-10-05 15:36:38
